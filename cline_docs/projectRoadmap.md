...
- [x] Sprint 1.2: The "Shapes on the Map" Slice (with GeoJSON fetched from GitHub LFS Media URL, local file removed, and basic styling added)
...
- [x] Completed Sprint 1.2: The "Shapes on the Map" Slice (with GeoJSON fetched from GitHub LFS Media URL, local file removed, and basic styling added)
