...
- [x] Sprint 1.2: The "Shapes on the Map" Slice (using minified GeoJSON hosted on jsDelivr CDN)
...
- [x] Completed Sprint 1.2: The "Shapes on the Map" Slice (using minified GeoJSON hosted on jsDelivr CDN)
